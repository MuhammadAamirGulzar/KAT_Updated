...
def merge_config_to_args(args, cfg):
    ...
    # data
    args.slide_list = os.path.join('/kaggle/working/KAT_Updated/dataset/tcga_lung/slide_list.pkl')
    args.task_list, args.lesions = get_slide_config(os.path.join("/kaggle/working/KAT_Updated/dataset/tcga_lung/dataset_config.pkl"))
